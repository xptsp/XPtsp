...
#AutoIt3Wrapper_icon=D:\XPtsp\Source\XPtsp.ico
#AutoIt3Wrapper_outfile=D:\XPtsp\XPtsp.exe
...
#AutoIt3Wrapper_Res_Fileversion=3.0.0.27
...
If 1 = 0 Then _IncludeFunc() ; <= Required to include functions called by "Execute" function!
...
Func _Registry_Info()
	...
	; Change a setting for the XP visual theme that we can't change anywhere else:
...
Func Live0_Run()
	...
	; Media Center only: If the new XP Pro visual style is to be the default, comment out lines in MEDCTROC.INF:
...
;====================================================================================
Func Page11_Build()
	; Move some stuff before starting:
	Local $OLD = $GUI, $S, $T
